...
teamName = 'Brain-Peepo Interface';
...
for tr=1:size(testData,1)
    ...
    for direc=randperm(8) 
        ...
        for t=times
            ...
            % add the new decoded position to the previous decoded hand
            % postion
            decodedHandPos = [decodedHandPos decodedPos];

            % TEMPORARY: Store the ground truth coordinates
            ground_truth = testData(tr,direc).handPos(1:2,t);

function [x, y, newParameters] = positionEstimator(test_data, modelParameters)
    ...
    % Post-processinng (strategy 1): adjust it based on prior knowledge
    % about expected behaviour. The final estimated postion is equal to 
    % the mean value mean position for each time step and angle (x_med)
